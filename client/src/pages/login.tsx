...
export default function Login() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (!userDoc.exists()) {
        // If user doesn't exist in Firestore, create basic user document
        const isAdmin = email === 'asif.s@ekkanoo.com.bh' || email === 'asif1001@gmail.com';
          ...
          <CardContent className="p-6 sm:p-8">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="text-center mt-4 text-xs text-gray-500">
                <p>Use your registered email and password to access OILDELIVERY</p>
              </div>
            </div>
          </CardContent>
        </Card>
